...
- 下载[点我下载](https://github.com/EnderWolf006/HomeworkBoard/releases/tag/latest)Latest版本的三个文件 `APIServer-release.py`  `ClientProject-release.zip` `SchoolProject-release.zip`
